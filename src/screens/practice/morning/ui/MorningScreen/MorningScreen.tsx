...
import { styles } from './MorningScreenStyle';

type MorningScreenType = NativeStackScreenProps<
  RootStackParamList,
  AppNavigation.MORNING
>;

export const MorningScreen = ({ navigation }: MorningScreenType) => {
    ...
    <ScreenContent
      ...
      <ScrollView
        ...
        <View style={styles.footer}>
          <NavigationSplash onPressNext={onPressNextHandler} />
        </View>
      </ScrollView>
    </ScreenContent>
  );
